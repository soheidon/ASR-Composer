...
export const asrProviders: ProviderDefinition[] = [
  ...
  { id: "google_stt", company: "Google Cloud", name: "Speech-to-Text", icon: "graphic_eq", env: "GOOGLE_CLOUD_API_KEY", defaultBaseUrl: "https://speech.googleapis.com/v2", defaultModel: "chirp_2", modelSource: "manual", allowManualModel: true, modelFilter: "asr" },
  ...
  { id: "xiaomi_mimo_asr", company: "Xiaomi MiMo", name: "Speech Recognition", icon: "graphic_eq", env: "XIAOMI_API_KEY", defaultBaseUrl: "", modelSource: "manual", allowManualModel: true, modelFilter: "asr" },
];
...
export const llmProviders: ProviderDefinition[] = [
  ...
  { id: "gemini", company: "Google", name: "Gemini", icon: "auto_awesome", env: "GOOGLE_API_KEY", defaultBaseUrl: "https://generativelanguage.googleapis.com/v1beta", modelSource: "api", allowManualModel: true, modelFilter: "llm", preferredModels: ["gemini-2.5-pro", "gemini-2.5-flash"] },

...
export const asrProviders: ProviderDefinition[] = [
  ...
  { id: "xiaomi_mimo_asr", company: "Xiaomi MiMo", name: "Speech Recognition", icon: "graphic_eq", env: "XIAOMI_API_KEY", defaultBaseUrl: "", modelSource: "manual", allowManualModel: false, modelFilter: "asr" },
